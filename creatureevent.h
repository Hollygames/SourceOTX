...
enum CreatureEventType_t : uint64_t
{
	...
	CREATURE_EVENT_INSERT_MARKET_MYOFFERS = 34, // market insert my offers in seller
	CREATURE_EVENT_INSERT_MARKET_ALLOFFERS = 35, // market insert all offers in buy 
	CREATURE_EVENT_INSERT_MARKETBUYOFFER_UPDATE = 36, // update market window (all offers, my offers) after buy item from market
	CREATURE_EVENT_INSERT_MARKET_MYHISTORIC = 37, // market insert my historic buyed of items
	CREATURE_EVENT_INSERT_MARKET_MAKEOFFREMOVEITEM = 38, // market make offer remove the item in pushed to slot
	CREATURE_EVENT_INSERT_MARKET_UPDATEOFFERS = 39, // market update makered offers
	CREATURE_EVENT_INSERT_MARKET_OFFERSTOME = 40, // market insert all offers to me
