...
enum Exhaust_t
{
	...
	EXHAUST_SPELLGROUP_SPECIAL2 = 9,
	EXHAUST_SPELLGROUP_SPECIAL3 = 10,
	EXHAUST_SPELLGROUP_KAWARIMI = 11,
	EXHAUST_POTION = 30,
	EXHAUST_MACHETE = 31
};
...
struct Outfit_t
{
	Outfit_t()
	{
		...
		lookAura = lookWings = healthBackground = manaBackground = 0;
	...
	Outfit_t(uint16_t _lookType)
	{
		lookType = _lookType;
		lookTypeEx = 0;
		lookHead = lookBody = lookAura = lookWings = healthBackground = manaBackground = lookLegs = lookFeet = lookAddons = 0;
	}

	uint16_t lookType, lookTypeEx;
	uint16_t lookAura, lookWings, healthBackground, manaBackground;
	...
	bool operator==(const Outfit_t& o) const
	{
		return (o.lookAddons == lookAddons
			...
			&& o.lookAura == lookAura && o.lookWings == lookWings
