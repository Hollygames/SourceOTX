...
void NetworkMessage::addItem(uint16_t id, uint8_t count, bool withDescription) //AION OTCV8 TOOL
{
	...
	if (withDescription) { //AION OTCV8 TOOL
		addString("");
	}
}

void NetworkMessage::addItem(const Item* item, bool withDescription) //AION OTCV8 TOOL
{
